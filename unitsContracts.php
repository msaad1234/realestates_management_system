...
<div id="unitContracts" class="row col-sm-12">
    ...
    <div id="section" class="col-12 col-md-7 col-lg-5">
        ...
        $sql = "SELECT * FROM contracts WHERE type='unit'";
        ...
        <ul>
            ...
            <li>
                ...
                <div class="operations">
                    <a href="files/unitsContracts/word_files/<? echo $word_file_name; ?>"><span class="btn btn-primary">تحميل العقد بصيغة word</span></a>
                    <a href="files/unitsContracts/pdf_files/<? echo $pdf_file_name; ?>"><span class="btn btn-primary">تحميل العقد بصيغة pdf</span></a>
                </div>
            </li>
