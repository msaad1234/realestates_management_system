            ...
            ?>
                <li>
                    ...
                    <div class="operations">
                        ...
                        <a href="unitsContracts.php?delete=<? echo $id; ?>"><span class="btn btn-danger col-12 col-md-12">حذف</span></a>
                    </div>
                </li>
...
?>
        <meta http-equiv="refresh" content="0;url=unitsContracts.php" />
    <?php
