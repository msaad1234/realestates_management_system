...
<div id="shop">
            ...
            <h3 class="col-12" style="text-align: right;">معلومات المحل</h3><br>
...
<form id="shopInformationForm" name="editShopInfo" class="col-sm-12 col-md-9 col-lg-6" method="POST" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF']."?id=".$_GET['id']; ?>" >
