...
<div id="print-info" class="col-12" style="text-align: center;"><a href="info.php?type=unit&id=<? echo $unit_id; ?>"><span class="btn btn-success col-5">إظهار التقرير</span></a></div>
    ...
    $contract_pdf = $row_unit['contract_pdf'];
    $id_image = $row_unit['id_image'];
    $id_pdf = $row_unit['id_pdf'];
    $mandate_image = $row_unit['mandate_image'];
    $mandate_pdf = $row_unit['mandate_pdf'];
                ...
                $(document).ready(function() {
                    ...
                    $(".contractPreviewBtn").click(function() {
                        ...
                        if (image_name.startsWith("<img>")) {
                            ...
                            viewer_window = "<embed src='files/unitsContracts/pdf_files/" + image_name.substr(image_name.indexOf('>') + 1) + "' style='width:100%; height: 100%;' />";
                        }
                        $("#image_preview").modal();
